...
opt.breakindent = true -- Maintain indentation in wrapped lines
opt.linebreak = true -- break lines at word boundaries
opt.textwidth = 80 -- lines automatically wrap at 80 chars
opt.colorcolumn = "80" -- visual indicator for line wrap
